...
import { patchSpecServers } from '@yasp/core/features/registration/utils/patch-spec-servers';
import type { ServerConfig } from '@yasp/core/features/registration/utils/spec-inference';
