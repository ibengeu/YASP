...
/**
 * Click/Press animation for buttons
 */
export function pressAnimation(target: HTMLElement) {
 ...
 */
export function hoverLift(target: HTMLElement, isHovering: boolean) {
  return animate(target, {
