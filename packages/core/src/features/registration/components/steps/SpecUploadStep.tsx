    ...
    <div className="space-y-6">
      ...
      <div>
          ...
          <TabsContent value="file" className="space-y-4 mt-4">
            <div className="flex items-center justify-center rounded-lg border-2 border-dashed border-border bg-muted/50 p-6 sm:p-8">
              <label className="cursor-pointer text-center">
                ...
                <p className="mt-1 text-xs sm:text-xs text-muted-foreground">YAML or JSON · max 5 MB</p>
                <input
                  type="file"
        ...
        {!hasSpec && (
          <p className="text-xs text-muted-foreground mt-3">
            Upload, paste, or fetch your OpenAPI/AsyncAPI spec. We'll use it to fill in the details.
          </p>
        )}
      </div>
      ...
      <div>
        ...
        <Input
          ...
          className={cn(
            fieldSources.endpoint === 'inferred' && 'border-secondary focus-visible:ring-secondary',
            fieldSources.endpoint === 'manual' && formData.endpoint && 'border-ring',
