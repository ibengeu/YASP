        ...
        <div className="space-y-3">
          ...
          <div>
            ...
            {jsonPath && !validation.valid && (
              <p className="text-[10px] text-destructive mt-0.5">{validation.error}</p>
            )}
          </div>
          ...
          {preview && (
            <div className="bg-muted rounded-md p-2">
              ...
              {preview.error ? (
                <p className="text-[10px] text-destructive mt-0.5">{preview.error}</p>
              ) : (
                <pre className="text-[10px] font-mono text-foreground mt-0.5 truncate">
