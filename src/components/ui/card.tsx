...
function Card({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      data-slot="card"
      className={cn(
        // Carbon card styling - minimal borders, clean background, sharp corners
        "bg-card text-card-foreground flex flex-col border border-border rounded-none",
        className,
      )}
      {...props}
    />
...
function CardTitle({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <h4
      ...
      className={cn("font-sans text-base font-normal leading-[1.33] tracking-0", className)}
      {...props}
    />
  );
}
