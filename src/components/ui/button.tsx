...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-none font-sans text-sm font-normal leading-[1.29] tracking-[0.16px] transition-all duration-75 ease-in-out disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4 shrink-0 [&_svg]:shrink-0 outline-none focus-visible:shadow-[inset_0_0_0_1px_var(--primary),inset_0_0_0_2px_var(--background)] focus-visible:ring-0",
  {
    variants: {
      variant: {
