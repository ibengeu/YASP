/**
 * OpenAPI Filter Dialog Component
 * Modal dialog containing advanced filtering options for the OpenAPI catalog
 */
...
interface OpenAPIFilterDialogProps {
  open: boolean;
...
export function OpenAPIFilterDialog({
  open,
  onOpenChange,
  filters,
  onFiltersChange,
