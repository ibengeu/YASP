...
import {Code, Database, FileJson, Search, Share2, Shield, Zap} from "lucide-react"
import {Link} from "react-router";

export default function LandingPage() {
    return (
        <div className="flex flex-col min-h-screen">
            <header className="border-b bg-[#dbbba5]/40 sticky top-0 z-10 ">
            ...
            <main className="flex-1">
                {/* Hero Section */}
                <section className="py-20 md:py-28 bg-[#3A2517] text-[#dbbba5] min-h-screen">
                        ...
                        <div className="grid gap-6 lg:grid-cols-[1fr_500px] lg:gap-12 xl:grid-cols-[1fr_550px]">
                            <div className="flex flex-col justify-center space-y-4">
                                <div className="space-y-2">
                                    ...
                                    <p className="max-w-[600px] text-[#dbbba5] md:text-xl">
                                ...
                                <div className="flex flex-col sm:flex-row gap-3">
                                    <Button size="lg" asChild className={"bg-[#004643]"}>
            ...
            <footer className="border-t py-6 md:py-8">
                <div
                    ...
                    <p className="text-sm text-muted-foreground">
                        &copy; {new Date().getFullYear()} API Collection. All rights reserved.
                    </p>
