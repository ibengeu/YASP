...
export default function TryItOut({path, method, operation, components}: TryItOutProps) {
    ...
    const resolveSchema = (currentSchema: SchemaObject | ReferenceObject): SchemaObject | ReferenceObject => {
    ...
    var schm = Object.entries((resolveSchema(requestBodySchema as ReferenceObject) as SchemaObject)?.properties || {})
        .reduce((acc, [key, value]) => ({ ...acc, [key]: value  }), {});

    console.log("schema:2", resolveSchema(requestBodySchema as ReferenceObject));
